...
namespace narwhal {
	VkSampler* NarwhalImageOld::textureSampler = nullptr;
	std::vector<NarwhalImageOld*> NarwhalImageOld::loadedImages{};
	NarwhalImageOld::NarwhalImageOld(NarwhalDevice& device, std::string name) : narwhalDevice{ device },
	...
	NarwhalImageOld::~NarwhalImageOld()
	{
	...
	bool NarwhalImageOld::imageExist(std::string fileName)
	{
	...
	NarwhalImageOld* NarwhalImageOld::getImage(std::string name) {
		for (auto image : loadedImages)
		{
			if (image->name == name)
			{
	...
	void NarwhalImageOld::loadImage(const std::string& filename)
	{
	...
	void NarwhalImageOld::createTexureImage(const std::string& filename)
	{
	...
	void NarwhalImageOld::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage,
	...
	void NarwhalImageOld::createTextureSampler(NarwhalDevice& device)
	{
	...
	VkImageView NarwhalImageOld::createImageView(VkFormat format)
	{
	...
	void NarwhalImageOld::createTextureImageView()	{
