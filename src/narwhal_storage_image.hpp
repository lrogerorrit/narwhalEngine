...
namespace narwhal {
	...
	{
		public:
		NarwhalStorageImage(NarwhalDevice& device, uint32_t width, uint32_t height, VkFormat imageFormat= VK_FORMAT_R32G32B32A32_SFLOAT, std::string name="STORAGE_IMAGE");
		~NarwhalStorageImage();
